...
davis_list = ["./indoor_flying4_full_new.h5 ",  # /home/xhlinxm/MVSEC/indoor_flying/indoor_flying1_data.hdf5
...
class MyData(Dataset):  # 这个类用于准备数据（取出所有数据）
    def __init__(self, file_index, train=True, engine_mask=False, stack_mode="SBT"):
        ...
        self.SBT_time = 0.05 # 固定事件间隔，除以SBT_num就是每一片的时间（秒）
    ...
    def get_single_item(self, ind):
        ...
        time_scaling=final_frame_interval/avg_frame_interval
...
if __name__ == '__main__':
    data = MyData(0, train=True, engine_mask=False, stack_mode="SBT")
