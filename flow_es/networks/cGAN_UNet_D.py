...
def D_unet_arch(ch=64, attention='64', ksize='333333', dilation='111111', out_channel_multiplier=1):
    ...
    arch[128] = {'in_channels': [32] + [ch * item for item in [1, 2, 4, 8, 16, 8 * n, 4 * 2, 2 * 2, 1 * 2, 1]],
...
if __name__ == '__main__':
    net = Unet_Discriminator(n_classes=2, unconditional=True)
